...
begin
  ...
  if v_tournament.match_format <> 'best_of_3' and not new.is_complete then
    return new;
  end if;
...
is 'Atomically rebuilds claimed-player stat rows whenever scores change; best-of-3 records every submitted game even if the partnership is unfinished.';
